...
class ResourceAccessModeCollectionTest extends TestCase
{
     ...
     * @dataProvider    dataProviderModesSeekable
     */
    public function testSeekable(AccessMode $mode): void
    {
    ...
    /**
     * @covers          AccessMode::get
     * @dataProvider    dataProviderModesNotSeekable
     */
    public function testNotSeekable(AccessMode $mode): void
    {
     ...
     */
    public function dataProviderModesSeekable(): array
    {
        $result = [];
     ...
     */
    public function dataProviderModesNotSeekable(): array
    {
        $result = [];
